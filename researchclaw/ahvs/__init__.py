"""researchclaw.ahvs — Adaptive Hypothesis Validation System.

AHVS is an 8-stage cyclic hypothesis-validation pipeline that composes
ARC's infrastructure (CodeAgent, EvolutionStore, LLMClient, sandbox) to
...
from researchclaw.ahvs.result import HypothesisResult
